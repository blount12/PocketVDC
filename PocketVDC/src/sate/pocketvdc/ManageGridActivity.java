...
public class ManageGridActivity extends DashboardActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, final View view,
				...
				// to modify menu.
				final String runTimeName = listView.getItemAtPosition(position)
						.toString();
				...
				final String[] stringArray = new String[] {
						"Edit " + runTimeName, "Delete " + runTimeName };
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								Toast.makeText(getApplicationContext(),
										stringArray[which] + which,
										Toast.LENGTH_SHORT).show();

								// Be careful with the hardcoding of cases
								switch (which) {
								case 0:
									Intent goToEdit = new Intent(view
											.getContext(),
											EditGridActivity.class);
									goToEdit.putExtra(CASE_TO_EDIT,
											selectedGrid);

									dialog.dismiss();

									startActivityForResult(goToEdit,
											DATA_FROM_EDIT_ACTIVITY);
		...
		addButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				Intent addIntent = new Intent(ManageGridActivity.this,
						AddGridActivity.class);
	...
	protected void onActivityResult(int requestCode, int resultCode,
		...
		if ((resultCode == Activity.RESULT_OK)
				&& (requestCode == DATA_FROM_EDIT_ACTIVITY)) {
		...
		// Add a grid
		if (resultCode == Activity.RESULT_OK
				&& requestCode == DATA_FROM_ADD_ACTIVITY) {
